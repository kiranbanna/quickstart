...
i2=0
sudo php /var/www/html/opencart/install/cli_install.php install --db_hostname $sqlserver --db_username "opencart" --db_password "anna" --db_database "opencart" --db_driver mysqli --username "admin" --password 'anna' --email "anna@f5.com" --http_server "http://localhost/opencart/"  || i2=$[$i2+1]
